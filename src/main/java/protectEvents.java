...
public class protectEvents {
	...
	public static class blockPlace{	
		@Listener
		public void onBlockBreak(ChangeBlockEvent.Place event) throws SQLException{
			Optional<Player> cause = event.getCause().first(Player.class);
			Player player = null;
			if (cause.isPresent()) {
				player = cause.get();
...
//		}
	...
	public static class blockModify{	
		@Listener
	...
	public static class blockInteract{	
		@Listener
...
//
//	}
	public static class liquidPlace{	
		@Listener
	...
	public static class liquidPlace2{	
		@Listener
